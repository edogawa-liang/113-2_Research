...
def parse_args():
    ...
    parser.add_argument("--node_choose", type=str, default="random", choices=["random", "high_degree", "top_pagerank", "manual", "choose_nodes"],  help="Name of the experiment folder") # both for explainer and random walk
    # random walk

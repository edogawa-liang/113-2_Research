...
# ------------------------------------------------------------
python training_main.py --dataset Cora --model MLP --epochs 1000 --lr 0.01 --run_mode stage1_mlp  --split_id 0
python training_main.py --dataset CiteSeer --model MLP --epochs 1000 --lr 0.01 --run_mode stage1_mlp --split_id 0
python training_main.py --dataset Amazon --model MLP --epochs 1000 --lr 0.01 --run_mode stage1_mlp --split_id 0
python training_main.py --dataset FacebookPagePage --normalize --model MLP --epochs 1000 --lr 0.01 --run_mode stage1_mlp --split_id 0
python training_main.py --dataset GitHub --normalize --model MLP --epochs 1000 --lr 0.01 --run_mode stage1_mlp --split_id 0
...
python testing_main.py --dataset Cora --model GCN2  --run_mode stage1_structure --split_id 0 --trial_start 0 --trial_end 0
python testing_main.py --dataset CiteSeer --model GCN2  --run_mode stage1_structure --split_id 0 --trial_start 0 --trial_end 0
python testing_main.py --dataset Amazon --model GCN2  --run_mode stage1_structure --split_id 0 --trial_start 0 --trial_end 0
python testing_main.py --dataset FacebookPagePage --normalize --model GCN2  --run_mode stage1_structure --split_id 0 --trial_start 0 --trial_end 0
python testing_main.py --dataset GitHub --normalize --model GCN2  --run_mode stage1_structure --split_id 0 --trial_start 0 --trial_end 0 

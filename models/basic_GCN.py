...
class FBGCN(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels1=64, hidden_channels2=32, out_channels=4):
        ...
        :param in_channels: Number of input features (determined by dataset).
        :param hidden_channels1: Number of hidden units in the first layer.
        :param hidden_channels2: Number of hidden units in the second layer.
...
# Example Usage (Automatically set `in_channels` based on dataset)
if __name__ == "__main__":
    ...
    model = FBGCN(in_channels=in_channels)
    print(model)

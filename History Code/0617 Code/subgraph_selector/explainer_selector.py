...
class ExplainerEdgeSelector:
    ...
    def __init__(self, data, base_dir, explainer_name, dataset_name, selected_nodes, top_k_percent, 
                 feature_type, device, top_k_percent_feat, use_feature_to_node, only_feature_node):
        """
